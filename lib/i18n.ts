...
const translations: Record<Locale, {
  ...
  ar: {
    ...
    hero: { ...hero, eyebrow: "طبقة الذكاء والتنفيذ لوكالات التسويق الحديثة", headlineLead: "اعرفوا أين يُعرَف نشاطكم التجاري", emphasis: ["ويُوصى به.", "ويُختار."], supporting: "ترسم GeoRepute بيئة القرار حول نشاطكم التجاري: عبر الذكاء الاصطناعي والبحث والسمعة والمنافسين والإشارات التي تؤثر في ما يختاره العملاء.", primaryCta: { label: "حلّلوا نشاطكم التجاري", href: "#analyze" }, secondaryCta: { label: "استكشفوا الذكاء", href: "#signals" }, scrollHint: "ادخلوا إلى النظام" },
  ...
  ru: {
    ...
    hero: { ...hero, eyebrow: "Слой интеллекта и исполнения для современных агентств", headlineLead: "Узнайте, где ваш бизнес", emphasis: ["распознают.", "рекомендуют.", "выбирают."], supporting: "GeoRepute отображает среду принятия решений вокруг вашего бизнеса: ИИ, поиск, репутацию, конкурентов и сигналы, влияющие на выбор клиентов.", primaryCta: { label: "Анализировать мой бизнес", href: "#analyze" }, secondaryCta: { label: "Изучить интеллект", href: "#signals" }, scrollHint: "Войти в систему" },
    invisible: invisibleDecision,
  },
  fr: {
  ...
  es: {
    ...
    hero: { ...hero, eyebrow: "La capa de inteligencia y ejecución para agencias modernas", headlineLead: "Vea dónde su negocio es", emphasis: ["reconocido.", "recomendado.", "elegido."], supporting: "GeoRepute traza el entorno de decisión alrededor de su negocio: IA, búsqueda, reputación, competidores y las señales que influyen en lo que eligen los clientes.", primaryCta: { label: "Analizar mi negocio", href: "#analyze" }, secondaryCta: { label: "Explorar la inteligencia", href: "#signals" }, scrollHint: "Entrar en el sistema" },
    invisible: invisibleDecision,
  },
  pt: {
